...
public enum ActivePlayerField
{
    ...
    ACTIVE_PLAYER_FIELD_BYTES_7                                       = PlayerField.PLAYER_END + 0xF52, // Size: 1, Flags: PUBLIC Nested: (InsertItemsLeftToRight, PvpRankProgress)
...
public enum ActivePlayerDynamicField
{
    ...
    ACTIVE_PLAYER_DYNAMIC_FIELD_DAILY_QUESTS_COMPLETED          = PlayerDynamicField.PLAYER_DYNAMIC_END + 0x002, // Flags: PUBLIC
