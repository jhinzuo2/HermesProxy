...
public enum Opcode : uint
{
    ...
    SMSG_ADVENTURE_JOURNAL_DATA_RESPONSE                         = 0x2887,
    ...
    SMSG_APPLY_MOUNT_EQUIPMENT_RESULT                            = 0x2863,
    ...
    SMSG_AUCTION_FAVORITE_LIST                                   = 0x287D,
    ...
    SMSG_AZERITE_RESPEC_NPC                                      = 0x27F2,
    SMSG_BAG_CLEANUP_FINISHED                                    = 0x2DA7,
    SMSG_BARBER_SHOP_RESULT                                      = 0x26B6,
    ...
    SMSG_BROADCAST_SUMMON_CAST                                   = 0x2856,
    SMSG_BROADCAST_SUMMON_RESPONSE                               = 0x2857,
    ...
    SMSG_CHROMIE_TIME_OPEN_NPC                                   = 0x27F7,
    SMSG_CHROMIE_TIME_SELECT_EXPANSION_SUCCESS                   = 0x2881,
    SMSG_CLAIM_RAF_REWARD_RESPONSE                               = 0x2867,
    ...
    SMSG_CLOSE_HEART_FORGE                                       = 0x2822,
    SMSG_CLUB_FINDER_ERROR_MESSAGE                               = 0x285F,
    SMSG_CLUB_FINDER_GET_CLUB_POSTING_IDS_RESPONSE               = 0x2862,
    SMSG_CLUB_FINDER_LOOKUP_CLUB_POSTINGS_LIST                   = 0x2860,
    SMSG_CLUB_FINDER_RESPONSE_CHARACTER_APPLICATION_LIST         = 0x285D,
    SMSG_CLUB_FINDER_RESPONSE_POST_RECRUITMENT_MESSAGE           = 0x2861,
    SMSG_CLUB_FINDER_UPDATE_APPLICATIONS                         = 0x285E,
    ...
    SMSG_CONVERT_ITEMS_TO_CURRENCY_VALUE                         = 0x288A,
    ...
    SMSG_COVENANT_RENOWN_OPEN_NPC                                = 0x2889,
    ...
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                            = 0x26F0,
    ...
    SMSG_EMOTE                                                   = 0x27C2,
    SMSG_ENABLE_BARBER_SHOP                                      = 0x26B5,
    ...
    SMSG_EXTERNAL_TRANSACTION_ID_GENERATED                       = 0x2888,
    ...
    SMSG_ISLANDS_MISSION_NPC                                     = 0x27F4,
    ...
    SMSG_ITEM_INTERACTION_COMPLETE                               = 0x2880,
    ...
    SMSG_LEVEL_LINKING_RESULT                                    = 0x2865,
    ...
    SMSG_OPEN_ANIMA_DIVERSION_UI                                 = 0x2712,
    SMSG_OPEN_CONTAINER                                          = 0x2DA6,
    SMSG_OPEN_HEART_FORGE                                        = 0x2821,
    SMSG_OPEN_LFG_DUNGEON_FINDER                                 = 0x2A31,
    SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP                           = 0x2792,
    ...
    SMSG_QUEST_SESSION_INFO_RESPONSE                             = 0x287B,
    ...
    SMSG_RAF_ACCOUNT_INFO                                        = 0x2866,
    SMSG_RAF_ACTIVITY_STATE_CHANGED                              = 0x2877,
    ...
    SMSG_RETURN_APPLICANT_LIST                                   = 0x285C,
    SMSG_RETURN_RECRUITING_CLUBS                                 = 0x285B,
    ...
    SMSG_SPLASH_SCREEN_SHOW_LATEST                               = 0x2882,
    ...
    SMSG_UI_ITEM_INTERACTION_NPC                                 = 0x27F3,
    ...
    SMSG_WEATHER                                                 = 0x269F,
    SMSG_WEEKLY_REWARDS_PROGRESS_RESULT                          = 0x2885,
    SMSG_WEEKLY_REWARDS_RESULT                                   = 0x2883,
    SMSG_WEEKLY_REWARD_CLAIM_RESULT                              = 0x2884,
    SMSG_WEEKLY_SPELL_USAGE                                      = 0x2C18,
    SMSG_WHO                                                     = 0x2BAE,
    SMSG_WHO_IS                                                  = 0x269E,
    SMSG_WILL_BE_KICKED_FOR_ADDED_SUBSCRIPTION_TIME              = 0x281F,
    SMSG_WORLD_MAP_OPEN_NPC                                      = 0x27F0,
